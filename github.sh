...
export name='hadriansilva-cps'
export email="hadrian.silva01@etec.sp.gov.br"
export repositorio="https://github.com/hadriansilva-cps/Projeto-Feira.git";

#Daqui pra baixo mexa somente se for realmente necessário ou se souber o que está fazendo :P

export branch_name="versão3-$(date +%Y%m%d%H%M%S)"
